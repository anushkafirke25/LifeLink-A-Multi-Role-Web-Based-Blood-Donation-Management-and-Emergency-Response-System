    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 font-medium"
        >
          {showForm ? t('dashboard.cancel') : t('events.create')}
        </button>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="submit"
                className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-lg hover:shadow-lg transition-all duration-200 font-medium"
              >
                {t('events.form.save')}
              </button>
              <button
          ...
          <div key={event._id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <span>👥</span>
                  <span className="font-semibold text-red-600">{event.registrationCount} registrations</span>
                </div>
              </div>
      ...
      {events.length === 0 && !showForm && (
        <div className="text-center py-12 bg-white rounded-2xl shadow-lg">
          ...
          <p className="text-gray-500 text-lg">No events created yet. Create your first campaign!</p>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="bg-gradient-to-r from-red-600 to-red-500 text-white p-6 flex justify-between items-center">
              <h3 className="text-2xl font-bold">{t('events.registrations.title')}</h3>
              <button
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <p className="text-gray-600">
                  {t('events.registrations.count')}: <span className="font-bold text-red-600">{registrations.length}</span>
                </p>
                <button
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 sticky top-0">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t('auth.bloodType')}</th>
